  ...
  return (
    <section className='pt-3 pb-10'>
      <div className='flex items-center gap-3'>
        ...
        <p className='text-sm'>
          Nunc enim lobortis quam risus et feugiat nibh eu ornare. Molestie sit nulla dolor diam
          turpis.
        </p>
      </div>
      ...
      <p className='text-sm'>
        ...
        labore et dolore magna aliqua. Cursus in hac habitasse platea dictumst quisque sagittis
        purus sit.
      </p>
    </section>
  );
